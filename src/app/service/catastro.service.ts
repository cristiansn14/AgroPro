...
export class CatastroService {
  ...
  obtenerCoordenadas(refCatastral: string): Observable<any> {
    const url = `https://ovc.catastro.meh.es/ovcservweb/OVCSWLocalizacionRC/OVCCoordenadas.asmx/Consulta_CPMRC?Provincia=&Municipio=&SRS=EPSG:4326&RC=${refCatastral}`;
